...
# -*- coding: utf-8 -*-
"""
GitHub Secret Scanner Pro - v2.1 优化版主程序
...
class OptimizedSecretScannerV21:
    """v2.1 优化版密钥扫描系统"""
    ...
    def start(self):
        ...
        logger.info("配置验证通过")
        logger.info("=" * 60)
        logger.info("GitHub Secret Scanner Pro v2.1")
        logger.info("=" * 60)
        ...
        # 启动验证器
        # 注意：这里仍使用原有的 start_validators，但内部会自动使用优化版验证器
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="GitHub Secret Scanner Pro v2.1 - 优化版",
